 ...
 *
 * Posledna zmena(last change): 28.12.2020
...
/* Servo sa zastaví pri nastavení 90°.
 * Zadaním menšej hodnoty ako 90° sa servo roztočí na jednu stranu
 * a zadaním větší hodnoty na druhú.
 * Čím viac se hodnota blíži 180° alebo 0°, tým väčšie sú otáčky serva. */
int min_servo = 600;      // Minimálna hodnota pre servo
int cen_servo = 1500;     // Stredná    -- // --         - STOP
int max_servo = 2400;     // Maximálna  -- // --
...
void setup() {
  ...
  // Nastavenie 
  analogWrite(pwm_pins[0], cen_servo); //Stop
  analogWrite(pwm_pins[1], cen_servo);
